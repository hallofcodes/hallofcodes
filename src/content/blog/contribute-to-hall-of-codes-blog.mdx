...
3. **Write Your Post**: Create a new Markdown file in the `content/blog` directory with your post. The file should follow the naming convention `your-post-title.mdx`.
   ...
   Please that the og_image are optional and will not be used if not provided and if you wanted to use a custom image, you can provide a URL to an image that will be used instead else use /images/your-image.jpg also make sure its compressed and optimized for performance.

   The author_url are optional and will not be used if not provided and if you wanted to use a custom URL, you can provide a URL to a profile page that will be used instead else use your GitHub username as the URL.
   ```
